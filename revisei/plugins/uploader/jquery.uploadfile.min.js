            ...
            for (var o = 0; o < r.length; o++)
                if (n(t, a, r[o].name))
                    if (a.allowDuplicates || !d(t, r[o].name))
                        ...
                        <div align="center">
                        <br>
                        Para adicionar mais imagens, se torne premium.
                        <br>
                        <a onclick="redirectAssinar()"> <button type="button" class="btn_preco">Assinar agora</button></a>
                        </div>
                        `).appendTo(t.errorLog);
                    else {
                        ...
                        // (g = a.showFileCounter ? t.fileCounter + a.fileCounterStyle +'' : ''), w.filename.html(g);
                ...
                function u(e, a) {
                    ...
                    function f(a, t) {
                        ...
                        return (
                            ...
                            (this.preview = e("<img class='ajax-file-upload-preview' />").width('auto').height(t.previewHeight).appendTo(this.statusbar).hide()),
                    ...
                    var w = e.extend(
                    {
                        ...
                        dragDropStr: "<span><b>Selecione os arquivos</b></span>",
                        uploadStr: "Selecionar",
                        abortStr: "Abortar",
                        cancelStr: "Cancelar",
                        deleteStr: "Deletar",
                        doneStr: "Pronto!",
                        multiDragErrorStr: "Não é permitido arrastar e soltar arquivos múltiplos arquivos.",
                        ...
                        maxFileCountErrorStr: "não é permitido. Os arquivos máximos permitidos são:",
